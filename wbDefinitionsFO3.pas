...
procedure DefineFO3(var gameProperties: TGameProperties);
...
procedure DefineFO3a(var gameProperties: TGameProperties);
begin
...
procedure DefineFO3b(var gameProperties: TGameProperties);
begin
  wbMiscStatEnum :=
    wbEnum([
      'Quests Completed',
...
procedure DefineFO3c(var gameProperties: TGameProperties);
begin
  wbRecord(
  gameProperties,
  CLMT, 'Climate', [
...
procedure DefineFO3d(var gameProperties: TGameProperties);
begin
  wbRecord(
  gameProperties,
  CSTY, 'Combat Style', [
...
procedure DefineFO3e(var gameProperties: TGameProperties);
begin
  wbRecord(
  gameProperties,
  PROJ, 'Projectile', [
...
procedure DefineFO3f(var gameProperties: TGameProperties);
begin
  wbRecord(
  gameProperties,
  WATR, 'Water', [
...
begin
  ...
  DefineFO3a(gameProperties);
  DefineFO3b(gameProperties);
  DefineFO3c(gameProperties);
  DefineFO3d(gameProperties);
  DefineFO3e(gameProperties);
  DefineFO3f(gameProperties);
end;
