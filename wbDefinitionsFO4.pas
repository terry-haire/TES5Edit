...
begin
   ...
   //wbAddGroupOrder(gameProperties, REFR);
   //wbAddGroupOrder(gameProperties, ACHR);
   //wbAddGroupOrder(gameProperties, PMIS);
   //wbAddGroupOrder(gameProperties, PARW);
   //wbAddGroupOrder(gameProperties, PGRE);
   //wbAddGroupOrder(gameProperties, PBEA);
   //wbAddGroupOrder(gameProperties, PFLA);
   //wbAddGroupOrder(gameProperties, PCON);
   //wbAddGroupOrder(gameProperties, PBAR);
   //wbAddGroupOrder(gameProperties, PHZD);
   wbAddGroupOrder(gameProperties, WRLD);
   //wbAddGroupOrder(gameProperties, LAND);
   //wbAddGroupOrder(gameProperties, NAVM);
   //wbAddGroupOrder(gameProperties, TLOD);
   ...
   //wbAddGroupOrder(gameProperties, TOFT);
   ...
   wbAddGroupOrder(gameProperties, DUAL); // doesn't exist but can be created in CK
   ...
   //wbAddGroupOrder(gameProperties, LSPR);
